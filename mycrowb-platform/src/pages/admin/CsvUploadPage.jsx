...
const csvColumns = [
  ...
  { key: 'state', required: false, description: 'State name (used for registration number prefix when provided).' },
  { key: 'latitude', required: false, description: 'Latitude in decimal format (example: 11.2588).' },
  { key: 'longitude', required: false, description: 'Longitude in decimal format (example: 75.7804).' },
  ...
  return (
    <Layout title="CSV Upload">
      <section className="max-w-3xl rounded-xl bg-white p-6 shadow-sm">
        <p className="text-gray-700">Bulk onboarding for shops across cities using a single CSV file. During upload, only ownerName, whatsappNumber, and shopName are mandatory. After upload, Shop Registration Number and Joined Date are auto-generated by the system and saved to the database.</p>
